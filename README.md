...
```bash
python -m src/train.py --config experiments/configs/imdb_cnn.yaml
```
...
```bash
python src/eval_attacks.py --config experiments/configs/imdb_cnn.yaml --ckpt experiments/logs/imdb_cnn.pt --output_csv experiments/logs/results_attacks.csv
```
...
```bash
python src/eval_attacks.py --config experiments/configs/imdb_cnn.yaml --ckpt experiments/logs/imdb_cnn.pt --sanitize --output_csv experiments/logs/results_attacks_sanitized.csv
```
...
```bash
python src/train_adv.py --config experiments/configs/imdb_cnn.yaml
```
...
```bash
python src/eval_attacks.py --config experiments/configs/imdb_cnn.yaml --ckpt experiments/logs/imdb_cnn_adv.pt --output_csv experiments/logs/results_attacks_adv.csv
```
